@ROAD-4550
Feature: [QAA-396] Add Standard HDD 16 Monthly

    As a user, I should able to add a Standard HDD 16 Monthly plan.
    
    @QAA-396
    Scenario Outline: [QAA-396] Add Standard HDD 16 Monthly
        ...
        Then I expect the Cart page displays the following information
           ...
           | Dedicated Server Hosting| $249.00/mo.    | Intel Xeon 4 core, 1 TB HDD, 16 GB | Monthly Plan |
       ...
       When I click "DedicatedServer"."SUBMIT_ORDER_BUTTON"
        ...
        Then I expect the Dedicated Servers Dashboard displays the following information
            ...
            | Pending | 16 GB        | 1 TB          | Cancel Order|
