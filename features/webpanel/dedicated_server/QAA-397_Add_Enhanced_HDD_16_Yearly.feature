@ROAD-4550
Feature: [QAA-397] Add Enhanced HDD 16 Yearly

    As a user, I should able to add a Enhanced HDD 16 Yearly plan.
    
    @QAA-397
    Scenario Outline: [QAA-397] Add Enhanced HDD 16 Yearly
