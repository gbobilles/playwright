@ROAD-4550
Feature: [QAA-398] Add Enhanced HDD 32 Monthly

    As a user, I should able to add a Enhanced HDD 32 Monthly plan.
    
    @QAA-398
    Scenario Outline: [QAA-398] Add Enhanced HDD 32 Monthly
        ...
        Then I expect the Cart page displays the following information
            ...
            | Dedicated Server Hosting   | $349.00/mo.    | Intel Xeon 12 core, 2 TB HDD, 32 GB| Monthly Plan |
        ...
        Then I expect the Dedicated Servers Dashboard displays the following information
            ...
            | Pending | 32 GB        | 2 TB          | Cancel Order|
