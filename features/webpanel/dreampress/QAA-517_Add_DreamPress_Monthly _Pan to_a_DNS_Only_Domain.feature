@ROAD-4456
Feature: [QAA-517][Dream Press] -Add DreamPress Monthly plan to a DNS Only domain

  As a user, I should able to see DreamPress Monthly plan.

  @QAA-517
  Scenario Outline: [QAA-517] Add DreamPress Monthly plan to a DNS Only domain
    ...
    Then I verify DreamPress purchase summery
      ...
      | Monthly | DreamPress | 30      | $23.99         | $23.99         |
